...
/**
 * Created by akshaynaik on 08/01/17.
 */
...
public class GPSTracker extends Service implements LocationListener {
  ...
  //  private GoogleMap mMap;
    ...
    private static final long MIN_TIME_BW_UPDATES = 3600000; // 5 minute
    ...
    Runnable run2 = new Runnable() {
        ...
        public void run() {
            try {
                ...
                String location = sLat + "," + sLong;

           //     Toast.makeText(getBaseContext(),"3:"+location,Toast.LENGTH_LONG).show();
