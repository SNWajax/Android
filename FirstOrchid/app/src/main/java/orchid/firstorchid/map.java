...
public class map extends android.app.Fragment implements OnMapReadyCallback,
     ...
     //   setContentView(R.layout.map);
       ...
       /* fab.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
            AutoCompleteTextView loc = (AutoCompleteTextView)findViewById(R.id.autoCompleteTextView);
    ...
    public void onExplore(){
        ...
        if(location!=null || !location.equals("")){
            ...
            mMap.addMarker(new MarkerOptions().position(latLng).title("Marker"));
            Toast.makeText(map.this,location,Toast.LENGTH_LONG).show();
            mMap.animateCamera(CameraUpdateFactory.newLatLng(latLng));
        }
    }
    ...
    public void onMapLongClick(LatLng latLng) {
        ...
        mMap.addMarker(new MarkerOptions()
                .position(latLng)
                .draggable(true));
        Toast.makeText(map.this, latLng.toString(),Toast.LENGTH_LONG).show();
    }
